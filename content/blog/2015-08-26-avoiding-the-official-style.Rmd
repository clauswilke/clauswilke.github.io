...
subtitle: "A few simple writing rules make your prose much simpler and easier to understand." 
summary: "A few simple writing rules make your prose much simpler and easier to understand." 
slug:  avoiding-the-official-style
authors:
 - admin
date:   2015-08-26
categories: ["Writing"]
tags: ["Academic writing", "Copy editing", "Official style"]
aliases: [/blog/2015/8/26/avoiding-the-official-style]
---
...
[^1]: M. Fang, X. Dai, and D. A. Theilmann. *Autographa californica* multiple nucleopolyhedrovirus EXON0 (ORF141) is required for efficient egress of nucleocapsids from the nucleus. *J. Virol.,* 81:9859–9869, 2007.
...
By following these guidelines, anyone can turn a dry, official-sounding document into a much more engaging piece of text. I have based these guidelines loosely on those presented in Lanham's book,[^2] though none of them are particularly novel for experienced copy writers or editors.

[^2]: R. L. Lanham. *The Longman Guide to Revising Prose.* Person Longman, New York, 2006.
...
Once you have identified the relevant actions in a sentence, you can then express them in simple verbs. To provide you with some examples, [Table 1](#tab1) shows several long-winded *is* statements alongside their shorter, verb-based form.
...
As a simple editing rule, eliminate all phrases of the form "*something something* is that" ([Figure  2](#fig2)). In most cases, these phrases don't contain any content anyways. And even if they do, there will usually be better ways to provide this content. For example, consider the opening of this abstract:[^5]
