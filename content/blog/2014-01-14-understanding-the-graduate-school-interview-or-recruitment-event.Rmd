...
subtitle: "The hardest part is to get invited in the first place."
summary: "The hardest part is to get invited in the first place."
slug: understanding-the-graduate-school-interview-or-recruitment-event
authors:
 - admin
date: 2014-01-14
categories: ["Academia"]
tags: ["Graduate admissions", "Graduate school", "Undergraduates", "Recruitment weekend"]
aliases: [/blog/2014/1/14/understanding-the-graduate-school-interview-or-recruitment-event]
---
...
[^1]: Unfortunately, there is no way to know for sure, unless you have heard the inside scoop from a member of this year’s admissions committee. Just because a program admitted 80% of their candidates last year doesn’t mean they won’t reduce their admissions pool to 50% this year and vice versa.
...
[^2]: You find these papers by searching for the faculty member’s publications on Google Scholar or Web of Science, sorting by number of citations (Google Scholar does this automatically), and looking at the most highly cited papers on which the faculty member was either first or last author.
