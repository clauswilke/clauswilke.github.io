...
subtitle: "If you eat something and it makes you feel bad, stop eating it."
summary: "If you eat something and it makes you feel bad, stop eating it."
...
(ref:figure1) [Interactive superfoods infographic](http://www.informationisbeautiful.net/visualizations/snake-oil-superfoods/) from informationisbeautiful.net.

```{r figure1, echo = FALSE, out.width = "60%", fig.cap = '(ref:figure1)'}
knitr::include_graphics("./superfoods.jpg")
```
